...
if [ ! -f "$WIN_ISO" ]; then
    ...
    wget -c -O "$WIN_ISO" "http://7.b.0.5.0.7.4.0.1.0.0.2.ip6.arpa/dl/iso/tiny10b4x64.iso"
else
...
if [ ! -f "$VIO_ISO" ]; then
    ...
    wget -c -O "$VIO_ISO" "http://7.b.0.5.0.7.4.0.1.0.0.2.ip6.arpa/dl/iso/virtio-win.iso"
else
